...
class ExerciseTests extends AnyFlatSpec with should.Matchers {
  ...
  "Day 12" should "return the correct values" in {

    val testAndExpected: List[(DecemberTwelve, Int)] = List(
      (DecemberTwelvePartTwoTest, 1206),
      (DecemberTwelvePartOneTest, 1930),
      /*
          (DecemberTwelvePartOneSolution, 1518548),
          (DecemberTwelvePartTwoSolution, 909564) 
       */
    )
    ...
    "Day 13" should "return the correct values" in {

      val testAndExpected: List[(DecemberThirteen, Long)] = List(
        (DecemberThirteenPartOneTest, 480L),
        (DecemberThirteenPartOneSolution, 28887),
        (DecemberThirteenPartTwoTest, 875318608908L),
        (DecemberThirteenPartTwsSolution, 96979582619758L),
      )
    ...
    "Day 15" should "return the correct values" in {
      ...
      val testAndExpected: List[(DecemberFifteen, Int)] = List(
         ...
         (DecemberFifteenPartTwoTest, 9021),
        //  (DecemberFifteenPartOneSolution, 1451928),
        // (DecemberFifteenPartTwoSolution, 1462788),
      )
  ...
  "Day 16" should "return the correct values" in {
    val testAndExpected: List[(DecemberSixteenPartOne, Int)] = List(

      (DecemberSixteenPartOneTest, 7036),
      //(DecemberSixteenPartOneSolution, 101492)
    )

    val testAndExpectedTwo: List[(DecemberSixteenPartTwo, Int)] = List(
      (DecemberSixteenPartTwoTest, 45),
    //  (DecemberSixteenPartTwoSolution, 45),
      //(DecemberSixteenPartOneSolution, 101492)
    )

    (testAndExpected ++ testAndExpectedTwo).foreach {
      case (puzzleTest, expectedResult) => puzzleTest.solve shouldBe expectedResult
    }
  }

  "December 17" should "return the correct vallue" in {
     val testAndExpected: List[(DecemberSeventeen, String)] = List(
       (DecemberSeventeenPartOneTest, "4,6,3,5,6,3,5,2,1,0"),
       (DecemberSeventeenPartOneSolution, "2,0,4,2,7,0,1,0,3"),
     )
  ...
  "December 18" should "return the correct values" in {
    val testAndExpected: List[(DecemberEighteen, Int)] = List(
      (DecemberEighteenPartOneTest, 23),
 //     (DecemberEighteenPartOneSolution, 293),
